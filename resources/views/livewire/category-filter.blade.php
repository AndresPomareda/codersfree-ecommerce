<div>
    <div class="bg-white rounded-lg shadow-lg mb-6">
        ...
        <div class="px-6 py-2 flex justify-between items-center">
            ...
            <div class="grid grid-cols-2
                ...
                <i class="fas fa-border-all p-3 cursor-pointer
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        <aside>
            {{-- Test para ver el contenido de la variable subcategoria que viene del wire:click="$set()"
                {{ $subcategoria }}
            --}}
            {{-- Muestra el Sub-Menu --}}
            ...
            {{-- Test para ver el contenido de la variable subcategoria que viene del wire:click="$set()"
                {{ $marca }}
            --}}
            <h2 class="font-semibold text-center mt-4">Marcas</h2>
            <ul class="divide-y divide-green-500">
